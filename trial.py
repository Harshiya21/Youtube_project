...
#video dataframe push to SQLAlchemy it will create and insert table
...
#comment dataframe push to SQLAlchemy it will create and insert table
    ...
    if data_migrate =="channel":
        ...
        st.warning("Please migrate data to MySQL first and ensure data was fetched successfully to view tables.")
#MYSQL connector
    mydb = mysql.connector.connect(
        host="localhost",
        user="root",
